...
var TotalRecall = React.createClass({ displayName: "TotalRecall",
    ...
    return (
      React.createElement("section", { className: classNames },
        ...
        store.curMemories.map(function (mem) {
          return (
            React.createElement(Button, { klass: "block memory transparent", text: mem, clickHandler: _this._recallMemory }));
...
var ButtonSetFunctions = React.createClass({ displayName: "ButtonSetFunctions",
...
var ButtonSetEquations = React.createClass({ displayName: "ButtonSetEquations",
...
var ButtonSetNumbers = React.createClass({ displayName: "ButtonSetNumbers",
...
var store = {
  ...
  get curMemories() {
    return this.memory.filter(function (m) {return m !== undefined;});
  },
